...
var RealtimeService = class extends BaseService {
  ...
  async subscribe(e2, t2) {
    ...
    return this.subscriptions[e2] || (this.subscriptions[e2] = []), this.subscriptions[e2].push(listener), this.isConnected ? 1 === this.subscriptions[e2].length ? await this.submitSubscriptions() : this.eventSource?.addEventListener(e2, listener) : await this.connect(), async () => this.unsubscribeByTopicAndListener(e2, listener);
  }
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701846927131.495";
}
var pb = new Client("http://127.0.0.1:8090");
var pocketbase_default = pb;

export {
  pocketbase_default
};
//# sourceMappingURL=/build/_shared/chunk-5BEURE6G.js.map
